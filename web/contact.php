...
-->
                            ...
                            <li class="active"><a href="contact.php">Kontak Kami</a></li>
                        </ul>
                    </nav>
                    <!-- //nav -->
    ...
    <section class="banner-bottom py-5">
        <div class="container py-md-5">
            <h3 class="title-wthree mb-lg-5 mb-4 text-center">Kontak Kami </h3>
            <div class="row contact_information">
                ...
                <div class="col-md-6 contact_left p-4">
                    <iframe src="https://www.google.com/maps/@-7.9119227,113.8248726,16z Bondowoso"></iframe>
                </div>
        ...
        <div class="container py-md-5">
            <div class="row">
                <div class="col-lg-3 footer_wthree_gridf mt-lg-5">
                    <h2><a href="index.php"><span>Tanya Buku
                        </a> </h2>
