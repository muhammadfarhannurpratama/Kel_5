...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="keywords" content="Tanya Buku Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    <script>
...
<body>
        ...
        <div class="banner-wthree-info container">
            <div class="row">
                ...
                <div class="col-lg-7 banner-img">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/dDxaRy19I30" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <img src="images/aa.jpg" alt="part image" class="img-fluid">
                    <img src="images/11.jpg" alt="part image" class="img-fluid">
                    <img src="images/qqq.jpg" alt="part image" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-md-5">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4 content-gd-wthree">
                    <img src="images/novel1.jpg" class="img-fluid" alt="" />
                </div>
                ...
                <div class="col-md-4 content-gd-wthree">
                    <img src="images/NOVEL.jpg" class="img-fluid" alt="" />
                </div>
            </div>
    ...
    <div class="cpy-right text-center py-3">
        <p>© 2019 Tanya Buku. DIbuat Oleh | Dan DI Desain
            <a href="http://w3layouts.com"> Polibon GG.</a>
        </p>
