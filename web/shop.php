...
<body>
        ...
        <header class="py-sm-3 pt-3 pb-2" id="home">
            <div class="container">
                ...
                <div class="top-w3pvt d-flex">
                    <div id="logo">
                        <h1> <a href="index.html"><span class="log-w3pvt">B</span>aggage</a> <label class="sub-des">Online Books</label></h1>
                    </div>
    ...
    <div class="cpy-right text-center py-3">
        <p>© 2019 Baggage. Di kerjakan Oleh | Design by
            <a href="http://w3layouts.com"> Polibon.</a>
        </p>
    </div>
    <!-- //copyright -->
