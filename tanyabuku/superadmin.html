...
<!-- navbar transaksi, akun,listuser, laporan, stok -->
            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="  navbar-nav ml-auto ">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href=""><b>Transaksi</b></a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href=""><b>Akun</b></a>
                    </li>

                    <li class="nav-item">
                            <a class="nav-link" href=""><b>List User</b></a>
                    </li>

                    <li class="nav-item">
                            <a class="nav-link" href=""><b>Laporan</b></a>
                    </li>

                    <li class="nav-item">
                            <a class="nav-link" href=""><b>Stok</b></a>
                    </li>
