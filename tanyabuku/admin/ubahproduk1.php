    ...
    <div class="card shadow mb-4">
      ...
      <div class="row">    
        <div class="col-sm-6">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <select class="form-control" name="barang" required="">
              ...
              <option value="Kosinyasi">Konsinyasi</option>
            </select>
          </div>
        </div>
      </div>
         <div class="row">
          ...
          <div class="form-group">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <img src="../foto_produk/<?php echo $pecah['foto_produk'] ?>"style="height: 318px;">
          </div>
         </div>
          <div class="col-sm-3">  
          <div class="form-group"><br><br><br><br><br><br><br><br><br>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="deskripsi" rows="10" minlength="10" maxlength="90" style="height: 281px;" required=""><?php echo $pecah['deskripsi_produk']; ?></textarea>
          </div>
        </div>
      </div>  
